...
public class DiscordPush {
   ...
   */
  public final static DiscordMessage SERVER_ONLINE =
      new DiscordMessage.Builder()
   ...
   */
  public final static DiscordMessage SERVER_OFFLINE =
      new DiscordMessage.Builder()
  ...
  public DiscordPush(String webhookUrl, Logger logger)
